      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            // Gradët e busullës - use RepaintBoundary to optimize
            RepaintBoundary(
            ...
            // Shigjetë e veriut - use RepaintBoundary to optimize
            RepaintBoundary(
              child: Transform.rotate(
                angle: -direction * (math.pi / 180),
                child: Container(
            ...
            // Shigjetë e jugut - use RepaintBoundary to optimize
            RepaintBoundary(
              child: Transform.rotate(
                angle: -direction * (math.pi / 180),
                child: Container(
            ...
            // Shigjeta e Kibles - use RepaintBoundary to optimize
            RepaintBoundary(
              child: Transform.rotate(
